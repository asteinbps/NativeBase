Object.defineProperty(exports,"__esModule",{value:true});exports.STabs=undefined;var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _jsxFileName='src\\smart\\STabs\\index.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=require('react');var _react2=_interopRequireDefault(_react);
...
alwaysBounceVertical:false,__source:{fileName:_jsxFileName,lineNumber:79}},
...
ref:function ref(scrollView){_this2.scrollView=scrollView;},__source:{fileName:_jsxFileName,lineNumber:99}},
...
key:idx,
style:{width:_this3.state.containerWidth},__source:{fileName:_jsxFileName,lineNumber:115}},
...
return _react2.default.createElement(_TabBar.TabBar,_extends({},props,{vertical:this.props.vertical,__source:{fileName:_jsxFileName,lineNumber:133}}));
}
...
return(
_react2.default.createElement(_reactNative.View,_extends({ref:function ref(c){return _this4._root=c;}},this.props,{__source:{fileName:_jsxFileName,lineNumber:153}}),
this.props.tabBarPosition==='top'&&this.renderTab(tabBarProps),
this.renderContent(),
_react2.default.createElement(_reactNative.View,{style:this.props.tabBarPosition==='bottom'?{bottom:_reactNative.Platform.OS==='ios'?0:23}:{},__source:{fileName:_jsxFileName,lineNumber:156}},
