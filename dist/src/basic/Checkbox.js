...
return(
_react2.default.createElement(_reactNative.TouchableOpacity,_extends({ref:function ref(c){return _this2._root=c;}},this.prepareRootProps(variables),{__source:{fileName:_jsxFileName,lineNumber:37}}),
_react2.default.createElement(_Ionicons2.default,{style:{
color:variables.checkboxTickColor,
fontSize:variables.CheckboxFontSize,
lineHeight:variables.CheckboxIconSize},
name:platform==='ios'&&platformStyle!=='material'?'ios-checkmark-outline':'md-checkmark',__source:{fileName:_jsxFileName,lineNumber:38}})));
